...
- For Facebook Sign-in
  - Go to [Facebook Developers Console](https://developers.facebook.com) and add http://ec2-35-162-229-47.us-west-2.compute.amazonaws.com to both **OAuth Redirect URI**.
